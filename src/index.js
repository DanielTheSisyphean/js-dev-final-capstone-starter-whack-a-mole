...
const options = document.querySelectorAll('#option'); /** Difficulty settings listening */
const stopButton = document.querySelector('#stopButton');
const score = document.querySelector('#score'); // Use querySelector() to get the score element
const timerDisplay = document.querySelector('#timer'); // use querySelector() to get the timer element.
const gameSound = new Audio('./assets/spaceSong.mp3');
gameSound.volume = .1;
const hitSound = new Audio('./assets/starSparkle.mp3');
let time = 0;
let timer;
let lastHole = 0;
let points = 0;
let difficulty = options.value;
...
/** Allow the player to stop the music if they want to.
 * this design choice is because the song is cool and I like listening to it, and having it stopped every time the game ends sounds silly. */
function stopMusic(){
  gameSound.pause();
